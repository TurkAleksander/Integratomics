...
class GWplot:
	def __init__(self, idxs, chrs, scores, sid):
		...
		self.figfile = '/Users/alesmaver/Dropbox/integr/website/static/uploadify/wgplots/%s.png' % self.sid
...
class getStudyTypes:
	def __init__(self, sid):
		...
		studyloc = '/Users/alesmaver/Dropbox/integr/temp/%s/Study*.txt' % sid
...
def importAnnot():
	...
	annoloc = '/Users/alesmaver/Dropbox/integr/annot/*.txt'
	...
	for annot in glob.glob(annoloc):
		...
		con = lite.connect('/Users/alesmaver/Dropbox/integr/sqlite3/annotation.db')
		cur = con.cursor()
...
def prepareBackbone(interval, overlap):
	z=open('/Users/alesmaver/Dropbox/integr/data/genome_coor_hg19.txt', 'r')
	...
	numIntervals = idx
	con = lite.connect('/Users/alesmaver/Dropbox/integr/sqlite3/test.db')
	cur = con.cursor()
...
def hgncImport(interval, overlap, numRegions):
	z=open('/Users/alesmaver/Dropbox/integr/data/Genes.txt', 'r')
...
def importAnnotStudy(studyFiles, study, studyTypes, studyNames, annoTypes, interval, overlap, cur, con):
	...
	cur.execute("ATTACH '/Users/alesmaver/Dropbox/integr/sqlite3/annotation.db' AS annotation")
...
class HelloWorld:
	...
	def ping(self, **kw):
		...
		render = web.template.render('/Users/alesmaver/Dropbox/integr/website/templates/')
		...
		np.savetxt("/Users/alesmaver/Dropbox/integr/perm_scores.txt", -np.log10(perMat2.scores))
		...
		np.savetxt("/Users/alesmaver/Dropbox/integr/myfile.txt", mat)
		...
		try:
			tdir = '/Users/alesmaver/Dropbox/integr/temp/%s' % sid
			os.mkdir(tdir)
		except:
			print "Folder already there!"

		rfile = '/Users/alesmaver/Dropbox/integr/temp/%s/results.txt' % sid
		f = open(rfile, 'w')
		for out in output:
			print out
		...
		webresultFile = '/Users/alesmaver/Dropbox/integr/website/static/uploadify/wgplots/%s.results.txt' % sid
	...
	def results(self):
		...
		yield '''<div style="max-width:100%;"><a href="''' + webresultFile + '''">Download results</a></div>'''
		yield '''</div> 
			<div id="sliders1">
				<form>
	...
	def dispatcher(self, **kw):
		...
		try:
			...
			if kw['static']=="1":
				...
				sdir = '/Users/alesmaver/Dropbox/integr/diseases/%s/results.txt' % kw['disease']
				print sdir
		...
		try:
			...
			if kw['static']=="0":
				try:
					...
					print "There is !"	
				sdir = '/Users/alesmaver/Dropbox/integr/diseases/%s/Study*.txt' % kw['disease']
				print sdir
				if not glob.glob(sdir):
	...
	def upload(self, **kw):
		...
		while True:
			...
			try:
				...
				print "Folder already there!"
			tfile = '/Users/alesmaver/Dropbox/integr/temp/%s/%s' % (sid, fname)
...
conf = {
	'/': {
		...
		'tools.staticdir.root': '/Users/alesmaver/Dropbox/integr/website/static/uploadify',
		'tools.staticdir.dir' : ''},
	'/index1':{
		'tools.staticdir.on' : True,
		'tools.staticdir.dir' : ''}}
